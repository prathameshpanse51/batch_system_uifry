...
import iphone from "./iPhone-13-Pro-Front (1).png";
    ...
    <>
      <div className="md:flex md:flex-row relative md:bottom-[180px] h-[100vh]">
        <div className="px-6 md:pl-40 mt-32">
          ...
          <h2 className="font-bold text-3xl md:text-5xl mt-2">
            Why Choose Uifry?
          </h2>
          ...
          <div className="mt-8 flex flex-col gap-6">
            <div>
              ...
              <p className="opacity-50 font-medium text-base md:text-lg mt-6">
        ...
        <div className="relative bottom-[115px] hidden md:block">
          <svg
            ...
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
            className="relative left-[80%] top-[110px]"
          >
            <path
          ...
          >
            ...
            />
            <div>
              <h3 className="text-sm">$560.00</h3>
              <p className="text-[#888B92] text-[9px]">From Adam</p>
            </div>
          </div>
          <Image
            src={iphone}
            alt={""}
            className="relative left-[170px] top-[-730px]"
          />
        </div>
      </div>
    </>
